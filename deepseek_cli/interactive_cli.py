...
import json
import sys
# Try to import readline (works on Linux/Mac) or use alternative for Windows
try:
    import readline  # For better input handling on Unix systems
except ImportError:
    # Windows doesn't have readline, use pyreadline3 instead
    try:
        import pyreadline3 as readline
    except ImportError:
        readline = None  # Fallback if neither is available
        print("Note: Command history and line editing disabled")
