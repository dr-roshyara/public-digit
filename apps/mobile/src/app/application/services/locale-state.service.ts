 ...
 *
 * DDD APPLICATION LAYER - Application state management
 *
 * PURPOSE:
 ...
 * REASON: This is application-level state management, not infrastructure
 */
...
/**
 * Application service managing locale state
 *
 * PROVIDES:
